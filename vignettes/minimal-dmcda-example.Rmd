...
```{r load_performance_tables}

# bla <- load_performance_table(file.path(currentDir,
#                                         "a_performance_table.xlsx"))

completed_performance_tables <-
  dmcda::load_performance_tables(file.path(currentDir));

knitr::kable(completed_performance_tables$multiEstimateDf);
