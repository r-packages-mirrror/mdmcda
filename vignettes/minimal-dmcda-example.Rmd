...
knitr::kable(estimates$multiEstimateDf[, c('decision_id', 'decision_alternative_value', 'criterion_id', 'all', "meanWeights_weight", "meanWeights_weighed_estimate")],
...
```{r scores-in-detail-per-scenario, results="asis"}

for (i in names(scenarioDefinitions)) {
  ...
  print(
    knitr::kable(
      rbind(
        weighedEstimates[weighedEstimates$scenario_id==i,
                         c("decision_id", "alternative_value",
                           "criterion_id", "estimate",
                           "meanWeights_weight", "meanWeights_weighed_estimate")],
        c("Sum", NA, NA, NA, NA,
          sum(weighedEstimates[weighedEstimates$scenario_id==i, 'meanWeights_weighed_estimate']))),
      col.names = c("Decision", "Alternative", "Criterion", "Estimate", "Weight", "Score"),
      row.names = FALSE)
  );
}
