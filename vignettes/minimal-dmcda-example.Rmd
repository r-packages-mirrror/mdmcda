...
```{r scores-in-detail-per-scenario}
...
for (i in names(scenarioDefinitions)) {
  ...
  print(knitr::kable(
    weighedEstimates[weighedEstimates$scenario_id==i, c("decision_id", "alternative_value",
                                                        "criterion_id", "estimate",
                                                        "meanWeights_weight", "meanWeights_weighed_estimate")],
    colnames=c("Decision", "Alternative", "Criterion", "Estimate", "Weight", "Score")));
}
