---
title: "Multi-Decision Multi-Criteria Decision Aid MDMA example"
author: "Gjalt-Jorn Peters"
date: "`r format(Sys.time(), '%H:%M:%S on %Y-%m-%d %Z (GMT%z)')`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Multi-Decision Multi-Criteria Decision Aid MDMA example}
...
criteria <-
  mdmcda::load_criteria_from_xl(file.path(dataDir,
                                         "mdma-example-fullCriteriaDf.xlsx"),
                               showGraphs = FALSE);
...
estimates <-
  mdmcda::load_performance_tables(input = file.path(dataDir),
...
weights <-
  mdmcda::load_weights_from_xl(input = file.path(dataDir,
                                                "mdma-example-criteria-weights.xlsx"));
...
scenariosFile <-
  file.path(dataDir,
            "mdma-example-scenario-definitions.xlsx");
...
childCriteriaByCluster <-
  criteria$criteriaDf[criteria$criteriaDf$leafCriterion, ]
childCriteriaByCluster <-
...
bestScenarioEstimates <-
  mdmcda::select_scenario_estimates(multiEstimateDf = estimates$multiEstimateDf,
                                   scenario = bestScenario);

bestScenarioEstimatesByCriterion <-
  mdmcda::aggregate_estimates_by_criterion(bestScenarioEstimates,
...
scoresPerScenario <-
  mdmcda::scores_by_scenario(weighedEstimates = weighedEstimates,
