---
title: "Multi-Decision Multi-Criteria Decision Aid example"
author: "Gjalt-Jorn Peters"
date: "`r format(Sys.time(), '%H:%M:%S on %Y-%m-%d %Z (GMT%z)')`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Multi-Decision Multi-Criteria Decision Aid example}
...
quietGitLabUpdate("r-packages/mdmcda");
